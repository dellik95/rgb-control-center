...
MyObject defSettings;

WS2812FX ws2812fx = WS2812FX(LED_COUNT, LED_PIN, NEO_RGB + NEO_KHZ400);
...
void setup() {
  ...
  ws2812fx.setColor(currentSettings.rColor, currentSettings.bColor, currentSettings.gColor);
  ws2812fx.start();
