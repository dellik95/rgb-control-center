...
namespace DellikCorp.Libs.ColorPicker.Controls
{
    ...
    {
        private long? locationHSProgressId;
        private long? locationLProgressId;
        private SKPoint locationHS;
        private SKPoint locationL;
        ...
        {
            if (color.GetLuminosity() != 0 || !IsInHSArea(locationHS, canvasRadius))
            {
