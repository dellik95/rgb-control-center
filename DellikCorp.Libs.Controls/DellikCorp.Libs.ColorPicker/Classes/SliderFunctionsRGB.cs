...
namespace DellikCorp.Libs.ColorPicker.Classes
{
    public static class SliderFunctionsRGB
    {
        ...
        {
            return (float)color.Red;
        }

        public static float NewValueG(Color color)
        {
            return (float)color.Green;
        }
        ...
        {
            return Color.FromRgba(newValue, oldColor.Green, oldColor.Blue, oldColor.Alpha);
        }

        public static Color GetNewColorG(float newValue, Color oldColor)
        {
            return Color.FromRgba(oldColor.Red, newValue, oldColor.Blue, oldColor.Alpha);
        }

        public static Color GetNewColorB(float newValue, Color oldColor)
        {
            return Color.FromRgba(oldColor.Red, oldColor.Green, newValue, oldColor.Alpha);
        }
